...
MM.widgets = {
    ...
    renderIframeModal: function(title, path) {
        ...
        var iframestyle = 'border: none; width: 100%; height: 100%; top:0; left:0; position:absolute;';
        ...
        var divstyle = 'overflow-y: scroll; -webkit-overflow-scrolling: touch; position:relative;';
